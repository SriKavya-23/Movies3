...
const convertMovieDbObjectToResponseDbObject=(dbObject)=>{
    return{
        ...
        movieIName:dbObject.movie_name;
...
app.get("/movies/:movieId/", async (request,response)=>{
    ...
    response.send(
       convertMovieDbObjectToResponseDbObject(movie)
    );
...
app.get("/directors/", async (request,response)=>{
    ...
    response.send(
        directorsArray.map((eachDirector)=>(convertDirectorDbObjectToResponseDbObject(eachDirector))
    )
    );
